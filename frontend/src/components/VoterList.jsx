                ...
                <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 shadow-lg mb-8">
                    ...
                    <div className="mt-4 flex gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <span className="text-blue-400 font-bold">{registeredUsers.filter(u => u.hasVoted).length}</span>
                        </div>
                    </div>
                </div>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={loading || user.isAuthorized}
                                                        ...
                                                        title={user.isAuthorized ? "Cannot delete authorized voter" : "Delete user"}
                                                    >
                                                        🗑️ Delete
                                                    </button>
                                                </div>
